...
class inputdata(object):
    ...
    def __init__( self, WORKSPACE_PATH, CoarseAIRFldr, PyCoarseAIRFldr, DtbHDF5Fldr, DtbWriteFldr, OutputWriteFldr ):
        ...
        ### CASE SPECIFIC
        self.TranVec                   = np.array([2500.0, 5000.0, 7500.0, 10000.0, 12500.0, 15000.0, 20000.0]) # np.array([2500.0, 5000.0, 7500.0, 10000.0, 12500.0, 15000.0, 20000.0])
        self.T0                        = 300.0
        self.iPES                      = 0
        ...
        self.DtbReadFldr               = self.WORKSPACE_PATH + '/CoarseAIR/O2C_ALL/Test/'
...
class kinetics(object):
    ...
    def __init__( self, WORKSPACE_PATH, DtbWriteFldr ):
        ...
        self.SytOfComplemExch           = ['CO2_NASA']
        self.ProcOfComplemExch          = np.array([3], dtype=np.int64)
        ...
        # self.GroupsOut_Flg              = True
        # self.GroupsOutWrite_Flg         = True
        # self.GroupsOutPathsToMapping    = ['/home/venturi/WORKSPACE/CoarseAIR/coarseair/dtb/Molecules/O2/NASA/Bins_49/LevelsMap_InelAmal49.csv', '/home/venturi/WORKSPACE/CoarseAIR/coarseair/dtb/Molecules/CO/NASA/Bins_83/LevelsMap_InelAmal83.csv']
        # self.NGroupsOut                 = np.array([49,83], dtype=np.int64)
        ...
        # self.GroupsOut_Flg              = True
        # self.GroupsOutWrite_Flg         = True
        # self.GroupsOutPathsToMapping    = ['/home/venturi/WORKSPACE/CoarseAIR/coarseair/dtb/Molecules/O2/NASA/Bins_49/LevelsMap_RVE49.csv', '/home/venturi/WORKSPACE/CoarseAIR/coarseair/dtb/Molecules/CO/NASA/Bins_83/LevelsMap_RVE83.csv']
        # self.NGroupsOut                 = np.array([49,83], dtype=np.int64)
