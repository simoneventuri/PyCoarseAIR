...
class inputdata(object):
    ...
    def __init__( self, WORKSPACE_PATH, CoarseAIRFldr, PyCoarseAIRFldr, DtbHDF5Fldr, DtbWriteFldr, OutputWriteFldr ):
        ...
        self.DtbReadFldr               = self.WORKSPACE_PATH + '/CoarseAIR/O4_UMN_CGM/Test/'
...
class kinetics(object):
    ...
    def __init__( self, WORKSPACE_PATH, DtbWriteFldr ):
        ...
        self.MolResolutionIn            = ['CGM', 'CGM', 'CGM', 'CGM', 'CGM', 'CGM']
        self.MinStateIn                 = np.array([     0,      0,     0,      0,     0,      0], dtype=np.int64)
        self.MaxStateIn                 = np.array([100000, 100000,100000, 100000,100000, 100000], dtype=np.int64)
        self.NGroupsIn                  = np.array([10,10,10,10,10,10], dtype=np.int64)
        self.GroupsInPathsToMapping     = ['/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv', 
                                           '/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv', 
                                           '/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv', 
                                           '/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv', 
                                           '/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv', 
                                           '/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/O3_UMN/O2/LevelsMap_DPM10.csv']
        self.GroupsInSuffix             = '_DP10'

        ## Resolution of the Kinetics Data in Output? Array of 'StS' / 'VSM' / 'CGM' of size Syst.NMolecules
        self.MinStateOut                = np.array([     0,      0,     0,      0,     0,      0], dtype=np.int64)
        self.MaxStateOut                = np.array([100000, 100000,100000, 100000,100000, 100000], dtype=np.int64)
        self.NGroupsOut                 = np.array([10,10,10,10,10,10], dtype=np.int64)
        self.GroupsOut_Flg              = False
        self.GroupsOutWrite_Flg         = False
        self.MolResolutionOut           = ['CGM', 'CGM', 'CGM', 'CGM', 'CGM', 'CGM']
